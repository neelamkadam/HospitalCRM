				...
				<Popover
					...
					<PopoverTrigger asChild>
						<Button
							...
							className={cn(
								"flex rounded-md border min-h-11 h-auto items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto",
												...
												return (
													<Badge
														...
														<div
															...
															className="ml-2 h-4 w-4 cursor-pointer hover:bg-white/20 rounded-sm p-0.5 -m-0.5 mb-0.5 focus:outline-none focus:ring-1 focus:ring-white/50">
															<XCircle
																className={cn(
																	"h-3 w-3",
																	responsiveSettings.compactMode &&
												...
												className={cn(
													...
													selectedValues.length ===
														getAllOptions().filter((opt) => !opt.disabled)
															.length
														? "bg-medistryColor text-primary-foreground"
