        ...
        <div className="fixed inset-0 z-[999] overflow-auto bg-black bg-opacity-40 flex items-center justify-center bg-black/20 backdrop-blur-sm">
          ...
          >
            ...
            <div className="mt-3 flex justify-center space-x-3">
              {!hideCloseBtn && <AppButton label="Close" className="mt-0 text-base !bg-white !text-[#293343]" onClick={onClose} />}
              <AppButton
                isLoading={isLoading}
                label={confirmTitle}
                onClick={onConfirm}
...
export default AppPatientRequestDialog;
