...
import {
  ...
  size,
  useFloating
} from "./chunk-AX6J5FEG.js";
import {
  autoUpdate
} from "./chunk-JB33ZFHM.js";
import {
  useDirection
...
import {
  ...
  useMergeRefs,
  zeroRightClassName
} from "./chunk-X3KSPDDO.js";
import {
  useEscapeKeydown
} from "./chunk-JWVHG6VC.js";
import {
  useId
} from "./chunk-4TH5XFV4.js";
import {
  useControllableState
} from "./chunk-YJDTXOED.js";
import {
  createContextScope,
  useCallbackRef,
  useLayoutEffect2
...
var Slot2 = React6.forwardRef((props, forwardedRef) => {
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime4.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children: React6.isValidElement(newElement) ? React6.cloneElement(newElement, void 0, newChildren) : null });
  }
...
function createCollection(name) {
  ...
  const CollectionSlot = import_react.default.forwardRef(
    (props, forwardedRef) => {
      ...
      return (0, import_jsx_runtime5.jsx)(Slot2, { ref: composedRefs, children });
    }
  );
  ...
  const CollectionItemSlot = import_react.default.forwardRef(
    (props, forwardedRef) => {
      ...
      return (0, import_jsx_runtime5.jsx)(Slot2, { ...{ [ITEM_DATA_ATTR]: "" }, ref: composedRefs, children });
    }
  );
...
function useComposedRefs2(...refs) {
  return React8.useCallback(composeRefs3(...refs), refs);
}
...
var Slot3 = React9.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime6.jsx)(SlotClone3, { ...slotProps, ref: forwardedRef, children: React9.isValidElement(newElement) ? React9.cloneElement(newElement, void 0, newChildren) : null });
  }
  return (0, import_jsx_runtime6.jsx)(SlotClone3, { ...slotProps, ref: forwardedRef, children });
});
Slot3.displayName = "Slot";
var SlotClone3 = React9.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
...
function isSlottable3(child) {
  return React9.isValidElement(child) && child.type === Slottable3;
}
...
var DismissableLayerBranch = React11.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime8.jsx)(Primitive2.div, { ...props, ref: composedRefs });
});
...
var Portal = React16.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime13.jsx)(Primitive2.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
function useComposedRefs3(...refs) {
  return React18.useCallback(composeRefs4(...refs), refs);
}
...
var Slot4 = React20.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime15.jsx)(SlotClone4, { ...slotProps, ref: forwardedRef, children: React20.isValidElement(newElement) ? React20.cloneElement(newElement, void 0, newChildren) : null });
  }
  return (0, import_jsx_runtime15.jsx)(SlotClone4, { ...slotProps, ref: forwardedRef, children });
});
Slot4.displayName = "Slot";
var SlotClone4 = React20.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
...
function isSlottable4(child) {
  return React20.isValidElement(child) && child.type === Slottable4;
}
...
var MenuContentImpl = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = useComposedRefs2(forwardedRef, contentRef, context.onContentChange);
