...
var I = (e2, t2) => {
  ...
  const m2 = null != (o2 = null == (n2 = window.visualViewport) ? void 0 : n2.width) ? o2 : innerWidth, p2 = null != (s2 = null == (r2 = window.visualViewport) ? void 0 : r2.height) ? s2 : innerHeight, { scrollX: b2, scrollY: g2 } = window, { height: w2, width: I2, top: x2, right: k2, bottom: N2, left: S2 } = e2.getBoundingClientRect(), { top: R2, right: $2, bottom: O2, left: B2 } = ((e3) => {
  ...
  let T2 = "start" === l2 || "nearest" === l2 ? x2 - R2 : "end" === l2 ? N2 + O2 : x2 + w2 / 2 - R2 + O2, W2 = "center" === a2 ? S2 + I2 / 2 - B2 + $2 : "end" === a2 ? k2 + $2 : S2 - B2;
  const j2 = [];
  for (let e3 = 0; e3 < f2.length; e3++) {
    const t3 = f2[e3], { height: n3, width: o3, top: r3, right: s3, bottom: u3, left: c3 } = t3.getBoundingClientRect();
    if ("if-needed" === i2 && x2 >= 0 && S2 >= 0 && N2 <= p2 && k2 <= m2 && x2 >= r3 && N2 <= u3 && S2 >= c3 && k2 <= s3) return j2;
    ...
    let R3 = 0, $3 = 0;
    const O3 = "offsetWidth" in t3 ? t3.offsetWidth - t3.clientWidth - v3 - E2 : 0, B3 = "offsetHeight" in t3 ? t3.offsetHeight - t3.clientHeight - y2 - C2 : 0, A2 = "offsetWidth" in t3 ? 0 === t3.offsetWidth ? 0 : o3 / t3.offsetWidth : 0, L2 = "offsetHeight" in t3 ? 0 === t3.offsetHeight ? 0 : n3 / t3.offsetHeight : 0;
    if (h2 === t3) R3 = "start" === l2 ? T2 : "end" === l2 ? T2 - p2 : "nearest" === l2 ? M(g2, g2 + p2, p2, y2, C2, g2 + T2, g2 + T2 + w2, w2) : T2 - p2 / 2, $3 = "start" === a2 ? W2 : "center" === a2 ? W2 - m2 / 2 : "end" === a2 ? W2 - m2 : M(b2, b2 + m2, m2, v3, E2, b2 + W2, b2 + W2 + I2, I2), R3 = Math.max(0, R3 + g2), $3 = Math.max(0, $3 + b2);
      ...
      R3 = "start" === l2 ? T2 - r3 - y2 : "end" === l2 ? T2 - u3 + C2 + B3 : "nearest" === l2 ? M(r3, u3, n3, y2, C2 + B3, T2, T2 + w2, w2) : T2 - (r3 + n3 / 2) + B3 / 2, $3 = "start" === a2 ? W2 - c3 - v3 : "center" === a2 ? W2 - (c3 + o3 / 2) + O3 / 2 : "end" === a2 ? W2 - s3 + E2 + O3 : M(c3, s3, o3, v3, E2 + O3, W2, W2 + I2, I2);
      const { scrollLeft: e4, scrollTop: i3 } = t3;
      R3 = 0 === L2 ? 0 : Math.max(0, Math.min(i3 + R3 / L2, t3.scrollHeight - n3 / L2 + B3)), $3 = 0 === A2 ? 0 : Math.max(0, Math.min(e4 + $3 / A2, t3.scrollWidth - o3 / A2 + O3)), T2 += i3 - R3, W2 += e4 - $3;
    }
...
var k;
var N = () => (k || (k = "performance" in window ? performance.now.bind(performance) : Date.now), k());
function S(e2) {
  const t2 = N(), n2 = Math.min((t2 - e2.startTime) / e2.duration, 1), o2 = e2.ease(n2), r2 = e2.startX + (e2.x - e2.startX) * o2, s2 = e2.startY + (e2.y - e2.startY) * o2;
...
function R(e2, t2, n2) {
  ...
  }, startTime: N(), startX: a2, startY: u2, x: t2, y: n2, duration: o2, ease: r2, cb: s2 });
}
var $ = function(e2, t2) {
  const n2 = t2 || {};
...
var O = (e2) => Object.values(e2).map((e3) => e3.current).filter(Boolean);
function B(e2, t2, n2, o2, r2, s2) {
  var i2;
...
var V = import_react.default.memo(function({ children: t2, className: n2, id: o2, index: r2, refs: s2 }) {
...
function H({ children: t2, itemClassName: o2 = v, refs: r2 }) {
  const s2 = import_react.default.Children.toArray(t2).filter(Boolean), i2 = import_react.default.useMemo(() => `${n} ${o2}`, [o2]);
  return s2.map((t3, n2) => {
    const o3 = A(t3);
    return import_react.default.createElement(V, { className: i2, id: o3, key: o3, refs: r2, index: n2 }, t3);
  });
}
function U({ className: t2 = v, children: n2, onScroll: r2 = () => {
...
function X({ items: t2, itemsChanged: n2, refs: o2, options: r2 }) {
  ...
  D(() => {
    const e2 = O(o2), t3 = s2.current || new IntersectionObserver(i2, r2);
    return s2.current = t3, e2.forEach((e3) => t3.observe(e3)), () => {
      t3.disconnect(), s2.current = void 0;
    };
  }, [i2, n2, r2, o2]);
}
var Y = (t2) => import_react.default.Children.toArray(t2).map(A).filter(Boolean);
...
function G({ LeftArrow: t2, RightArrow: n2, children: o2, Header: c2, Footer: d2, transitionDuration: h2 = 500, transitionBehavior: p2, onInit: b2 = K, onUpdate: y2 = K, onMouseDown: w2, onMouseLeave: E2, onMouseUp: M2, onMouseMove: C2, onScroll: I2 = K, onTouchMove: x2, onTouchStart: k2, onTouchEnd: N2, onWheel: S2 = K, options: R2 = _, scrollContainerClassName: $2 = v, containerRef: O2 = m, itemClassName: A2 = v, wrapperClassName: V2 = v, apiRef: P2 = z, RTL: q2, noPolyfill: G2 = true }) {
  const J = j(t2), Q = j(n2), Z = j(c2), ee = j(d2), te = import_react.default.useRef(null), [ne] = import_react.default.useState({}), oe = import_react.default.useMemo(() => Object.assign(Object.assign(Object.assign({}, _), R2), { root: te.current }), [R2]), re = import_react.default.useRef(new g()).current, se = function(t3, n3) {
    ...
    const o3 = import_react.default.useRef(true), r2 = import_react.default.useMemo(() => [n3 - 0.05, n3 - 0.01, n3, n3 + 0.01, n3 + 0.05], [n3]), s2 = import_react.default.useCallback((e2) => {
      var t4;
      o3.current = (null === (t4 = null == e2 ? void 0 : e2[0]) || void 0 === t4 ? void 0 : t4.intersectionRatio) >= n3;
    }, [n3]);
    return D(() => {
      const e2 = new IntersectionObserver(s2, { threshold: r2, rootMargin: "0px" });
      return t3.current && e2.observe(t3.current), () => e2.disconnect();
    }, [o3, t3, s2, r2]), o3;
  })(te, oe.ratio + 0.05 < 1 ? oe.ratio + 0.05 : 0.95);
  X(import_react.default.useMemo(() => ({ items: re, itemsChanged: se, options: oe, refs: ne }), [re, se, ne, oe]));
  const le = import_react.default.useMemo(() => function(t3, n3, o3, r2) {
    var s2, i2, l2;
    const a2 = (n4, o4 = false) => {
    ...
    }, u2 = !!(null === (s2 = t3.first()) || void 0 === s2 ? void 0 : s2.visible), c3 = !!(null === (i2 = t3.last()) || void 0 === i2 ? void 0 : i2.visible), d3 = (e2) => {
      var n4;
    ...
    }, v2 = null === (l2 = null == o3 ? void 0 : o3.boundary) || void 0 === l2 ? void 0 : l2.current;
    return { getItemById: d3, getItemElementById: T, getItemByIndex: (e2) => {
      var n4;
      return null === (n4 = t3.find((t4) => String(t4[1].index) === String(e2))) || void 0 === n4 ? void 0 : n4[1];
    }, getItemElementByIndex: W, getNextElement: f2, getPrevElement: h3, isFirstItemVisible: u2, isItemVisible: (e2) => t3.getVisible().map((e3) => e3[0]).includes(String(e2)), isLastItem: (e2) => t3.last() === d3(e2), isLastItemVisible: c3, scrollNext: (e2, t4, n4, { duration: s3, boundary: i3 = v2 } = {}) => {
      const l3 = null != e2 ? e2 : null == o3 ? void 0 : o3.behavior;
      return B(f2(), l3, t4 || "start", n4 || "nearest", { boundary: i3, duration: null != s3 ? s3 : null == o3 ? void 0 : o3.duration }, r2);
    }, scrollPrev: (e2, t4, n4, { duration: s3, boundary: i3 = v2 } = {}) => {
      const l3 = null != e2 ? e2 : null == o3 ? void 0 : o3.behavior;
      return B(h3(), l3, t4 || "end", n4 || "nearest", { boundary: i3, duration: null != s3 ? s3 : null == o3 ? void 0 : o3.duration }, r2);
    }, useIsVisible: a2, useLeftArrowVisible: () => {
      const t4 = a2("first", true), [o4, r3] = import_react.default.useState(t4);
      return import_react.default.useEffect(() => {
        n3.current && r3(t4);
      }, [t4]), o4;
    }, useRightArrowVisible: () => {
      const t4 = a2("last", false), [o4, r3] = import_react.default.useState(t4);
      return import_react.default.useEffect(() => {
        n3.current && r3(t4);
      }, [t4]), o4;
    }, scrollToItem: (e2, t4, n4, s3, i3) => {
      var l3;
      return B(e2, null != t4 ? t4 : null == o3 ? void 0 : o3.behavior, n4, s3, Object.assign(Object.assign({ boundary: v2 }, i3), { duration: null !== (l3 = null == i3 ? void 0 : i3.duration) && void 0 !== l3 ? l3 : null == o3 ? void 0 : o3.duration }), r2);
    } };
  }(re, ie, { duration: h2, behavior: p2, boundary: te }, G2), [re, h2, p2, G2, ie]), ae = import_react.default.useCallback(() => Object.assign(Object.assign({}, le), { items: re, scrollContainer: te, menuVisible: ie }), [le, re, te, ie]), [ue, ce] = import_react.default.useState(() => ae());
  ...
  })({ context: ue, onInit: b2, onUpdate: y2 }), import_react.default.useEffect(() => ce(ae()), [ae]), import_react.default.useEffect(() => {
    L(P2) ? P2.current = ue : P2(ue);
  }, [ue, P2]);
  const de = import_react.default.useCallback((e2) => I2(ue, e2), [I2, ue]), he = import_react.default.useCallback((e2) => S2(ue, e2), [S2, ue]), fe = import_react.default.useMemo(() => `${r} ${V2}`, [V2]), ve = import_react.default.useMemo(() => `${$2}${q2 ? " rtl" : v}`, [q2, $2]);
  return import_react.default.createElement("div", { className: fe, onWheel: he, onMouseDown: null == w2 ? void 0 : w2(ue), onMouseLeave: null == E2 ? void 0 : E2(ue), onMouseUp: null == M2 ? void 0 : M2(ue), onMouseMove: null == C2 ? void 0 : C2(ue), onTouchStart: null == k2 ? void 0 : k2(ue), onTouchMove: null == x2 ? void 0 : x2(ue), onTouchEnd: null == N2 ? void 0 : N2(ue) }, import_react.default.createElement(F.Provider, { value: ue }, import_react.default.createElement("div", { className: i }, Z), import_react.default.createElement("div", { className: s }, import_react.default.createElement("div", { className: l }, J), import_react.default.createElement(U, { className: ve, onScroll: de, scrollRef: te, containerRef: O2 }, import_react.default.createElement(H, { refs: ne, itemClassName: A2 }, o2)), import_react.default.createElement("div", { className: a }, Q)), import_react.default.createElement("div", { className: u }, ee)));
}
export {
  G as ScrollMenu,
